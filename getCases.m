...
% https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6G3S5UYM7HJ3N
    ...
    try
        ...
        ME2 = MException('getCases:io_error', 'Could not open source file.');
        throw(addCause(ME2, ME));
    end    
    if fid < 0
        error('getCases:io_error', 'Could not open source file.'); 
    end
    ...
    try  
        ...
        fclose(fid);
        ME2 = MException('getCases:read_error', 'Could not read file.');
        throw(addCause(ME2, ME));
    end
    fclose(fid);
    ...
    if doEval  
        ...
        for ii = 1:numel(cases)
            ...
            elseif isnumeric(newCases{ii}) || islogical(newCases{ii})
                ...
                warning('getCases:toString_more_complex',...
